...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/blackbox_dev_criticaldifference}
    \caption{Task Type: blackbox - Set: dev - Critical Difference}
    \label{fig:figures/blackbox_dev_criticaldifference}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/blackbox_dev_performancepertask}
    \caption{Task Type: blackbox - Set: dev - Performance per Task}
    \label{fig:figures/blackbox_dev_performancepertask}
\end{figure}

\subsection{Anytime Performance}
\begin{figure}[h]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/blackbox_dev_rank}
    \caption{Task Type: blackbox - Set: dev - Rank over Time}
    \label{fig:figures/blackbox_dev_rank}
\end{figure}
