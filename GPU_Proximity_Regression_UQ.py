...
class GPUProximityRegressionUQ:
    ...
    def fit(self):
        ...
        # Compute baseline training density
    ...
    def _compute_baseline_density(self) -> None:
        """Computes or recomputes baseline training density N_baseline based on topological_decay_lambda."""
