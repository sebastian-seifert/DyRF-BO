#!/bin/bash
# Submit Sweep 5 (Manifold OOD) in dependent 250-task chunks (MaxArraySize=300 limit)
set -e
...
echo "Submitting ${TOTAL_TASKS} tasks for Sweep 5 in chunks of ${CHUNK_SIZE} (MaxArraySize compliant)..."
