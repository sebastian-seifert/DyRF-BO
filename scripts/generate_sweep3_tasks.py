...
def main():
    ...
    output_dir = "results/sweep_3_fractional_sparse"
    ...
    metadata = {
        "sweep_name": "sweep_3_fractional_sparse",
        "description": "Fractional Sparse Hypercube Gap UQ Evaluation (Combined Proximity) across 44 functions, 7 seeds, 3 RF configs",
