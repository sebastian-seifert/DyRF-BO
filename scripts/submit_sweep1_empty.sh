#!/bin/bash
# Submit Sweep 1 (Empty Hypercube Gap) in dependent 250-task chunks (MaxArraySize=300 limit)
set -e
...
echo "Submitting ${TOTAL_TASKS} tasks for Sweep 1 in chunks of ${CHUNK_SIZE} (MaxArraySize compliant)..."
