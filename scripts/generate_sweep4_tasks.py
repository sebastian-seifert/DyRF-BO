...
def main():
    ...
    output_dir = "results/sweep_4_leaf_sparse"
    ...
    metadata = {
        "sweep_name": "sweep_4_leaf_sparse",
        "description": "Leaf Sparse Hypercube Gap UQ Evaluation (Combined Proximity) across 44 functions, 7 seeds, 3 RF configs",
