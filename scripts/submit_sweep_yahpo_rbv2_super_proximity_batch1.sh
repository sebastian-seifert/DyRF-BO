...
TASK_FILE="results/sweep_yahpo_rbv2_super_proximity/tasks.txt"
SBATCH_FILE="scripts/submit_sweep_yahpo_rbv2_super_proximity_array.sbatch"
...
echo "=================================================="
echo "Submitting yahpo_rbv2_super - BATCH 1 (Tasks $START_TASK to $END_TASK of $TOTAL_TASKS)"
...
echo "=================================================="
echo "Batch 1 for yahpo_rbv2_super successfully submitted!"
echo "=================================================="
